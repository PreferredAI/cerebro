...
import ai.preferred.cerebro.index.handler.VecDoubleHandler;
...
import ai.preferred.cerebro.index.lsh.utils.VecFloatHandler;
...
public class LoadSearcherRequest<TVector> {
    ...
    /**
     * Load index on hard disk and create a {@link ai.preferred.cerebro.index.lsh.search.LSHIndexSearcher} object.
