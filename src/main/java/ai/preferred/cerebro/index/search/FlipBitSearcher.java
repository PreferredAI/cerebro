...
/**
 * class to perform search like {@link LuIndexSearcher}, but also carry out search on the nearest sub-space determined
 * by flipping the nearest hash-bit
 *
 * @author hpminh@apcs.vn
 */
public class FlipBitSearcher extends LuIndexSearcher {
    ...
    protected TopDocs personalizedSearch(double [] vQuery, int topK)throws Exception{
        ...
        BytesRef[] hashAndFlip = lsh.getHashBitWithFlipClosest(vQuery);
